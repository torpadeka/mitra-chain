...
export function Roadmap() {
  return (
    <section className="py-30 min-h-screen bg-gradient-to-b from-background to-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {roadmapItems.map((item, index) => (
            <Card
              key={index}
              className="border-neutral-200 hover:shadow-lg transition-shadow shadow-neutral-200"
            >
              <CardContent className="p-6">
                ...
                <h3 className="font-jetbrains-mono font-bold text-lg text-primary mb-4">
                  {item.title}
                </h3>
