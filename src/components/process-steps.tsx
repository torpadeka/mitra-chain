        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {steps.map((step, index) => {
            ...
            return (
              <Card
                key={index}
                className="relative group hover:shadow-lg transition-shadow border-neutral-200 shadow-neutral-200"
              >
                <CardContent className="p-8">
                  ...
                  <div className="w-12 h-12 bg-green-400 rounded-lg flex items-center justify-center mb-4 group-hover:bg-green-200 transition-colors">
                    <IconComponent className="w-6 h-6 text-green-800" />
                  </div>
                  <h3 className="font-jetbrains-mono font-semibold text-xl text-primary mb-3">
                    {step.title}
                  </h3>
